...
.campo-estilizado:focus {
  outline: none; 
  box-shadow: 0 0 5px #f9df00; 
}
...
?>
<br><input type="button" value="Analizar" onclick="analizar()" class="boton-estilizado">
...
<div id="codigo">
<embed id="bus" type="text/html" src="https://www.bing.com/search?q=comprar+tenis+verdes+adidas" width="800px" height="800px">
</div>
